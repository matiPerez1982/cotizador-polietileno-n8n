...
* 📄 ** Documentación Técnica: Puedes acceder al documento completo con la arquitectura del flujo, el detalle de nodos y los esquemas JSON en el siguiente enlace:
* 📄 [Ver Documentación Técnica (PDF)](https://github.com/matiPerez1982/cotizador-polietileno-n8n/blob/main/DOCUMENTACION_TECNICA.pdf)
